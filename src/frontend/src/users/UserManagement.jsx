...
export default function UserManagement() {
  ...
  return (
    <section className="user-management-page">
                  ...
                  <tr key={user.id}>
                    ...
                    <td>
                      <div className="user-management-actions">
                        <button type="button" className="user-management-icon-btn" title="View" onClick={() => setViewUser(user)}><Icons.Eye /></button>
      ...
      <div className={`user-management-overlay${viewUser ? " open" : ""}`} onClick={(event) => event.target === event.currentTarget && setViewUser(null)}>
        <div className="user-management-modal">
          <div className="user-management-modal-header">
            <h2>User Details</h2>
            <button type="button" className="user-management-modal-close" onClick={() => setViewUser(null)}><Icons.X /></button>
          </div>
          {viewUser && (
            <>
              <div className="user-management-view-grid">
                {[
                  ...
                  <div className="user-management-view-field" key={label}>
                    <div className="user-management-view-label">{label}</div>
                    <div className="user-management-view-value">
                      {label === "Role" ? <span className={`user-management-badge ${roleClass(value)}`}>{value}</span> : value}
                    </div>
                  </div>
                ))}
              </div>
              <div className="user-management-modal-actions">
                <button type="button" className="user-management-btn-secondary" onClick={() => setViewUser(null)}>Close</button>
                <button type="button" className="user-management-btn-primary" onClick={() => { setViewUser(null); navigate(`/users/edit/${viewUser.id}`); }}>Edit User</button>
              </div>
            </>
          )}
        </div>
