...
export default function EditStore() {
  ...
  const handleUpdate = () => {
    if (validate()) showNotification("Store updated successfully!", "success");
  };
        ...
        <div style={{ marginLeft: "240px", flex: 1, display: "flex", flexDirection: "column", minHeight: "100vh" }}>
          ...
          <div style={{ padding: "28px", flex: 1 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "13px", color: "#6b7280", marginBottom: "8px" }}>
              ...
              <IconChevron />
              <span style={{ color: "#0f1623" }}>Edit Store</span>
            </div>

            <h1 style={{ fontSize: "24px", fontWeight: "700", color: "#0f1623", margin: "0 0 24px 0", letterSpacing: "-0.4px" }}>Edit Store</h1>
            ...
            <div style={{ background: "#fff", borderRadius: "12px", border: "1px solid #e5e7eb", overflow: "hidden", maxWidth: "780px" }}>
              ...
              <div style={{ padding: "18px 22px", borderBottom: "1px solid #e5e7eb", display: "flex", alignItems: "center", gap: "10px" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "2px" }}>Update the store information below.</div>
                </div>
              </div>
              ...
              <div style={{ padding: "22px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px", marginBottom: "16px" }}>
                  <div>
                    <label style={{ display: "block", fontWeight: "600", fontSize: "12.5px", marginBottom: "6px", color: "#0f1623" }}>
                      Store ID <span style={{ marginLeft: "6px", color: "#6b7280", display: "inline-flex", verticalAlign: "middle" }}><IconInfo /></span>
                    </label>
                    <input value={form.storeId} disabled style={{ width: "100%", border: "1.5px solid #e5e7eb", borderRadius: "8px", padding: "10px 12px", fontFamily: "inherit", fontSize: "13.5px", color: "#6b7280", background: "#f4f6fb", cursor: "not-allowed", boxSizing: "border-box" }} />
                    <span style={{ fontSize: "11px", color: "#6b7280", marginTop: "3px", display: "block" }}>Fixed system identifier</span>
                  </div>
                  <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px", borderTop: "1px solid #e5e7eb", paddingTop: "18px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#6b7280", marginTop: "2px" }}>Optional — GPS coordinates for map pinning.</div>
                  </div>
                </div>
